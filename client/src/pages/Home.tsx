...
export default function Home() {
    ...
    return (
      <main className="relative min-h-screen overflow-hidden bg-[#fff9fc] text-[#2a2030]">
        ...
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-7 lg:px-10">
          <div className="flex items-center gap-3 text-lg font-bold tracking-tight"><span className={`grid size-10 place-items-center rounded-xl bg-[#f5b8d2] ${border} shadow-[3px_3px_0_#2a2030]`}><CloudUpload className="size-5" /></span>DropVault</div>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-6 pb-20 pt-14 lg:grid-cols-[1fr_0.85fr] lg:px-10 lg:pb-32 lg:pt-24">
          ...
          <div className="relative mx-auto w-full max-w-md">
            ...
            <div className={`relative rounded-[1.4rem] bg-white p-5 ${border} ${softShadow}`}>
              <div className="mb-5 flex items-center justify-between text-xs font-bold uppercase tracking-[0.16em] text-[#756b7c]"><span>DROPVAULT / MY FILES</span><MoreHorizontal className="size-4" /></div>
  ...
  return (
    <main className="min-h-screen bg-[#fff9fc] text-[#2a2030]">
      <header className="border-b-2 border-[#2a2030] bg-white"><div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10"><div className="flex items-center gap-3"><span className={`grid size-10 place-items-center rounded-xl bg-[#f5b8d2] ${border} shadow-[3px_3px_0_#2a2030]`}><CloudUpload className="size-5" /></span><span className="text-lg font-black tracking-tight">DropVault</span><span className="hidden rounded-full border border-[#2a2030] bg-[#eeeaff] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider sm:inline">Personal</span></div><div className="flex items-center gap-3"><div className="hidden text-right sm:block"><p className="text-sm font-bold">{user?.name || "Your workspace"}</p><p className="text-xs text-[#756b7c]">{user?.email || "Account aktif"}</p></div><Button onClick={() => logout()} variant="ghost" size="icon" className="rounded-xl border-2 border-transparent hover:border-[#2a2030] hover:bg-[#fff0f6]"><LogOut className="size-4" /></Button></div></div></header>
